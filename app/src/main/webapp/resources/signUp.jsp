			...
			<div class="col-lg-5 col-xl-5 mx-auto">
				<div class="card card-signin flex-row my-5">
					...
					<div class="card-body">
						 ...
						 <img src="reg1.png" id="animated-img1">
						 </div>
						 <br />
						<form class="form-signin">
							...
							<div class="form-label-group">
								<input type="password"  name="password" id="inputConfirmPassword"
									...
									for="inputConfirmPassword"></label>
							</div>

							<input class="btn btn-lg btn-primary btn-block text-uppercase"
								type="submit" value="SignUp">
								<div>
								<a  class="txt1" href="http://localhost:8025/app/resources/signIn.jsp">already have an account?</a>
							 </div>
